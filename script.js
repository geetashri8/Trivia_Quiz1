...
function fetchQuestionsForCategory(category) {
    ...
    fetch(`${quizAPI}?categories=${category}&limit=2&difficulty=hard`)
        ...
        //console.log('fetchQuestionsForCategory');
}
...
function displayQuestion(playerDivId, questionData, difficulty, player) {
    ...
    if(playerDivId === 'player-1-questions'){
        document.querySelector('.Player-2').style.display = 'none';
        document.querySelector('.Player-1').style.display = 'block';
    }else{
        document.querySelector('.Player-1').style.display = 'none';  
        document.querySelector('.Player-2').style.display = 'block'; 
    }
